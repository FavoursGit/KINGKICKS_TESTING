...
<header>
    ...
    <div class="shoe">
        <div class="image">
            <img src="images/yshoes7-Photoroom.png" alt="adidas Yeezy 450 Resin">
        </div>
        <div class="description">
            <h2>adidas Yeezy 450 Resin</h2>    
            <h2>€55</h2>
    ...
    <section class="trending">
        ...
        <div class="product-box">
            <a href="shoe2.php"><img src="images/shoes7-Photoroom.png" alt="Image 3">
            <div class="price">€115</div>
        </div>
        <div class="product-box">
