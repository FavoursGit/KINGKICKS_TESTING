...
<header>
    ...
    <div class="shoe">
        <div class="image">
            <img src="images/yshoes3-Photoroom.png" alt="adidas Yeezy Boost 350 V2 Zebra">
        </div>
    ...
    <section class="trending">
        ...
        <div class="product-box">
            <a href="yshoe1.php"><img src="images/yshoes3-Photoroom.png" alt="Image 2">
            <div class="price">€115</div>
        </div>
        <div class="product-box">
            <a href="yshoe7.php"><img src="images/shoes7-Photoroom.png" alt="Image 3">
            <div class="price">€115</div>
        </div>
        <div class="product-box">
