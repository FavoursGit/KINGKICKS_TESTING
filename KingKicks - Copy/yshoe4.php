...
<header>
    ...
    <div class="shoe">
        <div class="image">
            <img src="images/yshoes4-Photoroom.png" alt="adidas Yeezy Foam RNR Onyx">
        </div>
        <div class="description">
            <h2>adidas Yeezy Foam RNR Onyx</h2>    
            <h2>€80</h2>
            <p>The Adidas Yeezy Foam RNR is a sleek,
                all-black slip-on sneaker made from lightweight EVA foam and algae-based materials. 
                It features a futuristic, sculpted design with large cutouts for breathability and comfort,
                making it a stylish and eco-friendly footwear option.
            </p>
