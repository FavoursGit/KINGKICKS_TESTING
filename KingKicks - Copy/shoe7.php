...
<header>
    ...
    <div class="shoe">
        <div class="image">
            <img src="images/shoes8-Photoroom.png" alt="Air Jordan IV  Retro “Black Cat">
        </div>
        <div class="description">
            <h2>Nike Dunk Low-Top Trainers Black & White</h2>    
            <h2>€115</h2>
    ...
    <section class="trending">
        ...
        <div class="product-box">
            <a href="shoe3.php"><img src="images/shoes3-Photoroom.png" alt="Image 2">
            <div class="price">€115</div>
        </div>
        <div class="product-box">
            <a href="shoe8.php"><img src="images/shoes8-Photoroom.png" alt="Image 3">
            <div class="price">€1,729</div>
        </div>
        <div class="product-box">
            <a href="shoe2.php"><img src="images/shoes2-Photoroom.png" alt="Image 4">
            <div class="price">€115</div>
        </div>
    </section>
    <footer>
